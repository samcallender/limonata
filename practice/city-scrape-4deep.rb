...
diagrams_id_a.each do |n|
	...
	# begin page 2
	city = HTTParty.get('http://skyscraperpage.com/diagrams/?searchID='+n+'&page=2')
	...
	city = HTTParty.get('http://skyscraperpage.com/diagrams/?searchID='+n+'&page=3')
	...
	city = HTTParty.get('http://skyscraperpage.com/diagrams/?searchID='+n+'&page=4')
